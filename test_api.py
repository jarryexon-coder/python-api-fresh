    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if players:
                ...
                missing_fields = [
                    field for field in critical_fields if field not in first_player
                ]
                if missing_fields:
                ...
                available_projection_fields = [
                    ...
                    if field in first_player and first_player[field]
                ]
                ...
                for team in teams:
                    ...
                    if players and len(players) > 0:
                        ...
                        if isinstance(first_player, dict):
                            print(
                                f"  First player is an object with keys: {list(first_player.keys())}"
                            )
                        else:
